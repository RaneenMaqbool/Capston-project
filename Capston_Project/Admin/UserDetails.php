...
<div class="page-content page-container" id="page-content">
    <div class="padding">
        <div class="row container d-flex justify-content-center">
                            <a href="Request.php"><br><br><img src="css/home.png" width="50" height="50"></a><br><br>
...
while($row=mysqli_fetch_assoc($result)){
 echo "<img src='../Vendor/Login/images/{$row['image']}' width='200' height='200'>";
}?>
                                </div>
  <!-- Trigger the modal with a button -->
  <br><br><br><button type="button" class="button button2" id="btn" data-toggle="modal" data-target="#myModal" >Show Company Licence</button>
...
$result=mysqli_query($con,$query);
while($row=mysqli_fetch_assoc($result)){
 echo "<img src='../Vendor/Login/images/{$row['image2']}' width='500' height='400'>";
}?></p>
        </div>
