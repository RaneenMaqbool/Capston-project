...
while($row=mysqli_fetch_assoc($result)){
    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            <li class="text-left">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1><strong>Welcome To <br> Atomkit Shop</strong></h1>
                            <p>High Quality Clothes  <br> trends and brands.</p><br>
                            <p><a class="btn hvr-hover" href="#" style="background:#EB596E">Shop Now</a></p>
                        </div>
                    </div>
                </div>
            </li>
            <li class="text-left">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1><strong>Welcome To <br> Atomkit Shop</strong></h1>
                            <p class="m-b-40">High quality Cars <br>  cars with special price and modules </p>
                            <p><a class="btn hvr-hover" href="#" style="background:#EB596E">Shop Now</a></p>
                        </div>
                    </div>
                </div>
            ...
            <li class="text-left">
                <img src="images/accc.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1><strong>Welcome To <br> Atomkit Shop</strong></h1>
                            <p class="m-b-40">High quality Accessories <br> trendy See the collection.</p>
                            <p><a class="btn hvr-hover" href="#" style="background:#EB596E">Shop Now</a></p>
                        </div>
                    </div>
                </div>
                ...
                <li class="text-left">
                <img src="images/bags.webp" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1><strong>Welcome To <br> Atomkit Shop</strong></h1>
                            <p class="m-b-40">High quality Shoes and bags <br> trendy See the collection.</p>
                            <p><a class="btn hvr-hover" href="#" style="background:#EB596E">Shop Now</a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="slides-navigation">
            <a href="#" class="next" style="background:#EB596E"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
            <a href="#" class="prev" style="background:#EB596E"><i class="fa fa-angle-left" aria-hidden="true"></i></a>
        </div>
    </div>
    <!-- End Slider -->
    ...
    <div class="categories-shop">
        <div class="container">
            <div class="row">
                ...
                echo  "<img class='img-fluid' src='../Admin/images/{$value['category_image']}' alt='' style='width:250px;height:300px;'/>";
                echo "<a class='btn hvr-hover' href='shop.php?id={$value['category_id']}' style='background:#EB596E'>{$value['category_name']}</a>";
                echo "</div>";
                echo "</div>";
                }
                 ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                foreach($data as $value){
                   ...
                   echo  "<div class='blog-box' style='height:520px;'>";
                    echo "<div class='blog-img'>";
                    echo "<img class='img-fluid' src='../Vendor/images/{$value['images']}' style='height:200px;width:400px;'alt='' />";
                    echo "</div>";
                    echo "<div class='blog-content'>";
                    echo "<div class='title-blog'>";
                    echo "<h3>{$value['post_title']}</h3>";
                    echo "<p>{$value['post_desc']}</p>";
                    echo "</div>";
                    echo "<h3 style='margin-left:50px;font-style:italic'>Phone:{$value['vendor_phone']}</h3>";
                    echo "<h3 style='margin-left:50px;font-style:italic'>Company:{$value['vendor_name']}</h3>";
                    echo "<ul class='option-blog'>";
                    echo "</ul>";
                    echo  "</div>";
                    echo "</div>";
                    echo "</div>";
