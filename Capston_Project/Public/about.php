...
<html lang="en">
<!-- Basic -->
<?php $con=mysqli_connect("localhost","root","","capstone");
?>
<head>
    <meta charset="utf-8">
...
while($row=mysqli_fetch_assoc($result)){
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="noo-sh-title">We are <span>ATOMKIT</span></h2>
            ...
            <div class="row my-5">
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        ...
                        <p>We’re fostering an open and inviting community by creating a new destination for local residents. Our plans infuse nature into the urban landscape and create a unique. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
                        <h3>We are Professional</h3>
                        <p>submitted a proposed development plan for the second phase of new construction for our Arlington headquarters. </p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="service-block-inner">
