...
if(isset($_POST['add'])){
   ...
   $query="insert into contact(name,email,subject,phone,message)
    ...
    echo "<script> alert('Thank for sending message We will calling you during 24 hours')</script>";
}
?>
...
while($row=mysqli_fetch_assoc($result)){
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>Atomkit submitted a proposed development plan for the second phase of new construction for our Arlington headquarters. We’re fostering an open and inviting community by creating a new destination for local residents..</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="phone" placeholder="Your phone" required data-error="Please enter your name">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="message" placeholder="Your Message" rows="4" data-error="Write your message" required name="message"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="submit-button text-center">
                                        <input class="btn hvr-hover" id="submit" type="submit" style="background:#EB596E;color:#fff" name="add" value="Send Message">
    ...
    <a href="#" id="back-to-top" title="Back to top" style="display: none;" style="color:#EB596E;background:#EB596E">&uarr;</a>
