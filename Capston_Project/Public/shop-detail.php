...
$total=1;
  $con=mysqli_connect("localhost","root","","capstone");
  $query="insert into cart(price,image,qty,total,name)
      values('$price','$image','$quantity',0,'$name')";
       mysqli_query($con,$query); 
       echo '<meta http-equiv="refresh" content="0">';
$query="select price,image,qty,SUM(qty*price) AS Total_Value,total,name from cart";
$result=mysqli_query($con,$query);
while($row=mysqli_fetch_assoc($result)){
    $cx=$row['Total_Value'];
    
  $query="insert into carts(price,image,qty,total,alltotal,name)
      values('$price','$image','$quantity','$cx',('$quantity'*'$price'),'$name')";
       mysqli_query($con,$query);    
}
         }
...
while($row=mysqli_fetch_assoc($result)){
    ...
    <div class="shop-detail-box-main">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            $con=mysqli_connect("localhost","root","","capstone");
                                        ...
                                        $result=mysqli_query($con,$query);
                                         while($row=mysqli_fetch_assoc($result)){
                            echo "<div class='carousel-item active'> <img class='d-block w-100' src='../Vendor/images/{$row['images']}' alt='First slide' name='image12'> </div>";
                                         }?>
                ...
                <div class="col-xl-7 col-lg-7 col-md-6">
                    <div class="single-product-details">
                        ...
                        echo "<p class='available-stock'> {$row['qty']} <strong>available</strong><p>";
                            echo "<h4>Short Description:</h4>";
                            echo "<p>{$row['product_des']}</p>";
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="form-group quantity-box">
                                            ...
                                            <input class="form-control" value="0" min="0" max="20" type="number" name="number">
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="price-box-bar">
                                    <div class="cart-and-bay-btn">
                                        <input type="submit" name="Add" class="btn hvr-hover" style="background:#EB596E" value="Add to cart">
                                    </div>
                                </div>
            ...
            <br><br><br><br><br><center><h1 style="font-weight:bold;font-size:30px;font-style:italic">Product color</h1></center>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 shop-content-right">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                        ...
                                        <?php
                                        $k=$_SESSION['category_id'];
                                        $con=mysqli_connect("localhost","root","","capstone");
                                        $id=$_GET['id'];
                                    //$query="select * from product where category_id = '$k'    LIMIT 6";
                                        $query="select * from product where product_name='$tt'";
                                         $result=mysqli_query($con,$query);
                                         while($row=mysqli_fetch_assoc($result)){
                 ...
                 <br><br><br><br><br><center><h1 style="font-weight:bold;font-size:30px;font-style:italic">Related Product</h1></center>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                        ...
                                        $id=$_GET['id'];
                                    //$query="select * from product where category_id = '$k'    LIMIT 6";
                                        $query="select  * from product where category_id='$k' ORDER BY RAND() LIMIT 9";
                                         $result=mysqli_query($con,$query);
                                         while($row=mysqli_fetch_assoc($result)){
                                            echo "<div class='col-sm-6 col-md-6 col-lg-4 col-xl-4'>";
                                            echo "<div class='products-single fix'>";
