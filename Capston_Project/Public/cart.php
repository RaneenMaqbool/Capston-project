                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background:#EB596E">Update</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                echo "</td>";
                                    ...
                                    echo "<td class='quantity-box'><input type='number' size='4' value='{$row['qty']}' min='0' step='1' class='c-input-text qty text' name='num'></td>";
                                   echo "<td class='price-pr'>
                                        <p>$ {$row['alltotal']}</p>";
                                    echo "</td>";
                                    ...
                                    echo "<a href='update_Cart.php?id={$row['cart_id']}'>Update</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                   echo "<form>";
...
<?php
             $query="select SUM(alltotal) as tot from carts";
                ...
                echo "<hr>";
                echo "<form action='' method='post'>";
                echo "<div class='col-12 d-flex shopping-box'><a href='Login/Form.php' class='ml-auto btn hvr-hover' style='background:#EB596E;padding:14px 33px;'>Checkout</a> </div>";
                echo "</div>";
                echo "</form>";
